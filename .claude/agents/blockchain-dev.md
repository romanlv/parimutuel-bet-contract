---
name: blockchain-dev
description: Use this agent when you need to develop, review, debug, or optimize blockchain smart contracts and related infrastructure. This includes writing new smart contracts, implementing token standards (ERC20, ERC721, etc.), creating DeFi protocols, auditing contract security, optimizing gas usage, writing test suites for contracts, integrating with blockchain networks, or solving complex blockchain architecture problems. The agent specializes in Solidity, Foundry, Hardhat, and other blockchain development tools.\n\nExamples:\n<example>\nContext: User needs help implementing a new feature in their smart contract.\nuser: "I need to add a staking mechanism to my token contract"\nassistant: "I'll use the blockchain-smart-contract-developer agent to help implement the staking mechanism."\n<commentary>\nSince the user needs smart contract development work, use the blockchain-smart-contract-developer agent to design and implement the staking feature.\n</commentary>\n</example>\n<example>\nContext: User has written smart contract code and wants it reviewed.\nuser: "I've just finished writing the claim function for my betting contract"\nassistant: "Let me use the blockchain-smart-contract-developer agent to review your claim function for security and optimization."\n<commentary>\nThe user has completed smart contract code that needs review, so use the blockchain-smart-contract-developer agent to analyze it.\n</commentary>\n</example>
model: inherit
color: yellow
---
